...
int main(){
	...
	float *x = (float*) malloc(dataPoints* sizeof(float)); // input data x
	float *y = (float*)malloc(dataPoints* sizeof(float)); // input data y
	float *a = (float*)malloc(dataPoints* sizeof(float)); // coefficients a (intercept)
	float *b =(float*) malloc(dataPoints* sizeof(float)); // coefficients b (slope)
